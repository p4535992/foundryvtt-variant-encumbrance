                        ...
                        buttons.unshift({
                            ...
                            onclick: async (ev) => {
                                if (index === 0) {
                                    ...
                                    mylabel = Logger.i18n(
                                        "variant-encumbrance-dnd5e.label.disableVEAndWEOnSpecificActor",
                                    );
                                    myicon = "fas fa-feather";
                                    index = 2;
                                } else if (index === 2) {
                                    ...
                                    enableVarianEncumbranceWeightOnSpecificActorFlag = true;
                                    mylabel = Logger.i18n(
                                        "variant-encumbrance-dnd5e.label.enableVEAndWEOnSpecificActor",
                                    );
                                    myicon = "fas fa-weight-hanging";
                                    index = 0;
                                } else if (index === 3) {
                    ...
                    buttons.unshift({
                        ...
                        onclick: async (ev) => {
                            if (indexBulk === 0) {
                                ...
                                mylabelBulk = Logger.i18n(
                                    "variant-encumbrance-dnd5e.label.enableWEBulkOnSpecificActor",
                                );
                                myiconBulk = "fas fa-balance-scale-left";
                                indexBulk = 1;
                            } else if (indexBulk === 1) {
                                ...
                                mylabelBulk = Logger.i18n(
                                    "variant-encumbrance-dnd5e.label.disableVEAndWEBulkOnSpecificActor",
                                );
                                myiconBulk = "fas fa-feather-alt";
                                indexBulk = 2;
                            } else if (indexBulk === 2) {
                                ...
                                enableVarianEncumbranceWeightBulkOnSpecificActorFlag = true;
                                mylabelBulk = Logger.i18n(
                                    "variant-encumbrance-dnd5e.label.enableVEAndWEBulkOnSpecificActor",
                                );
                                myiconBulk = "fas fa-bold";
                                indexBulk = 0;
                            } else if (indexBulk === 3) {
