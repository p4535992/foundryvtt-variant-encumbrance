...
**Feature: Do Not apply weight for equipped armor item:** This is a homebrew rule, for equipped armor types (clothing, light, medium, heavy, natural), if the weight is set to 0 is not applied, this will override the setting from _'Equipped Item Weight Multiplier'_. **NOTE:** The specific armor calculation setting _'Feature: Equipped Armor Weight Multiplier for 'XXX Armor'_ will be override this setting.
